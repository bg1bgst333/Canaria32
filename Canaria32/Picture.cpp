...
BOOL CPicture::Create(LPCTSTR lpctszWindowName, DWORD dwStyle, int x, int y, int iWidth, int iHeight, HWND hWndParent, HMENU hMenu, HINSTANCE hInstance){
	...
	return CCustomControl::Create(_T("Static"), lpctszWindowName, dwStyle | SS_BITMAP, x, y, iWidth, iHeight, hWndParent, hMenu, hInstance);	// CCustomControl::Createでウィンドウクラス"Static"で作成.
...
void CPicture::OnLButtonDown(UINT nFlags, POINT pt){
...
// マウスの左ボタンが離された時.
void CPicture::OnLButtonUp(UINT nFlags, POINT pt){
